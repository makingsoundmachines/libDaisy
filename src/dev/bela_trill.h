#pragma once
#ifndef DSY_DEV_BELA_TRILL_H
#define DSY_DEV_BELA_TRILL_H /**< Macro */
#include <stdlib.h>
#include <stdint.h>
#include <string>
#include <vector>
 ...
 * Original code by Bela / Augmented Instruments Ltd. - http://bela.io/trill
...
class Trill
{
  ...
  public:
    ...
    /**
         ...
         *
         * @param i2c_bus handle for the I2C bus that the device is connected to.
         ...
         */
    Trill(const I2CHandle i2c,
          Device          device,
          uint8_t         i2c_address); // uint8_t i2c_address = 255
    /**
         * \copydoc Trill::Trill(unsigned int, Device, uint8_t)
         *
         * @return 0 upon success, an error code otherwise.
         */
    int setup(const I2CHandle i2c,
              Device          device,
              uint8_t         i2c_address); // uint8_t i2c_address = 255
